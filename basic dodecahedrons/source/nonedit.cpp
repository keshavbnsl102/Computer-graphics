...
struct VAO *create3DObject(GLenum primitive_mode, int numVertices, const GLfloat *vertex_buffer_data, const GLfloat red, const GLfloat green, const GLfloat blue, GLenum fill_mode) {
    GLfloat *color_buffer_data = new GLfloat[3 * numVertices];
     GLfloat f = static_cast <float> (rand()) / static_cast <float> (RAND_MAX);
     GLfloat g= static_cast <float> (rand()) / static_cast <float> (RAND_MAX);
     GLfloat h = static_cast <float> (rand()) / static_cast <float> (RAND_MAX);
    ...
    for (int i = 0; i < numVertices; i++) {
     f = static_cast <float> (rand()) / static_cast <float> (RAND_MAX);
       g= static_cast <float> (rand()) / static_cast <float> (RAND_MAX);
        ...
        color_buffer_data[3 * i]     = f;
        color_buffer_data[3 * i + 1] = g;
        color_buffer_data[3 * i + 2] = h;
      }
  }
  if(numVertices==120)
 {
...
struct VAO *create3DObject(GLenum primitive_mode, int numVertices, const GLfloat *vertex_buffer_data, const color_t color, GLenum fill_mode) {
    ...
    return create3DObject(primitive_mode, numVertices, vertex_buffer_data, f , g , h , fill_mode);
}
